...
Entity::Entity(int level)
        : animationComponent(nullptr), attributeComponent(nullptr), speed(0), velocity({0.f, 0.f}), position{0.f, 0.f}, animationSpeed(0), isAnimated(false), frameCount(0), currentFrame(0), frameWidth(0), frameHeight(0), timeDelta(0) {
}
